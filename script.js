function Attacker(name,en,primaries){
  this.name=name;
  this.enabled=en;
}

var sledge = new Attacker ("Sledge",true);
var thatcher = new Attacker ("Thatcher",true);
var ash = new Attacker ("Ash",true);
var thermite = new Attacker ("Thermite",true);
var twitch = new Attacker ("Twitch",true);
var montagne = new Attacker ("Montagne",true);
var glaz = new Attacker("Glaz",true);
var fuze = new Attacker("Fuze",true);
var iq = new Attacker("IQ",true);
var blitz = new Attacker("Blitz",true);
var buck = new Attacker("Buck",true);
var blackbeard = new Attacker("Blackbeard",true);
var capitao = new Attacker("Capitao",true);
var hibana = new Attacker("Hibana",true);
var jackal = new Attacker("Jackal",true);
var ying = new Attacker("Ying",true);
var zofia = new Attacker("Zofia",true);
var dokkaebi = new Attacker("Dokkaebi",true);
var lion = new Attacker("Lion",true);
var finka = new Attacker("Finka",true);
var maverick = new Attacker("Maverick",true);
var nomad = new Attacker("Nomad",true);
var gridlock = new Attacker("Gridlock",true);
var nokk = new Attacker("Nokk",true);
var amaru = new Attacker("Amaru",true);
var kali = new Attacker("Kali",true);
var iana = new Attacker("Iana",true);
var ace = new Attacker("Ace",true);
var zero = new Attacker("Zero",true);

var operators_attackers = Array(sledge.name, thatcher.name, ash.name, thermite.name, twitch.name, montagne.name, glaz.name, fuze.name, iq.name , blitz.name, buck.name, blackbeard.name, capitao.name, hibana.name, jackal.name, ying.name, zofia.name, dokkaebi.name, lion.name, finka.name, maverick.name, nomad.name, gridlock.name, nokk.name, amaru.name, kali.name, iana.name, ace.name, zero.name
                               );
...
function choose(Attacker){
  Attacker.enabled=!Attacker.enabled;
  var stat= Attacker.enabled;
  if (stat){
    operators_attackers.push(Attacker.name);
  }else{
    var index = operators_attackers.indexOf(Attacker.name);
    operators_attackers.splice(index, 1);
  }

}

document.getElementById("Sledge").onclick = function (){
  choose(sledge);
}

document.getElementById("Thatcher").onclick = function (){
  choose(thatcher);
}

document.getElementById("Ash").onclick = function (){
  choose(ash);
}

document.getElementById("Thermite").onclick = function (){
  choose(thermite);
}
...
document.getElementById("Glaz").onclick = function (){
  choose(glaz);
}

document.getElementById("Fuze").onclick = function (){
  choose(fuze);
}

document.getElementById("Blitz").onclick = function (){
  choose(blitz);
}
...
document.getElementById("Buck").onclick = function (){
  choose(buck);
}

document.getElementById("Blackbeard").onclick = function (){
  choose(blackbeard);
}
...
document.getElementById("Hibana").onclick = function (){
  choose(hibana);
}
...
document.getElementById("Ying").onclick = function (){
  choose(ying);
}

document.getElementById("Zofia").onclick = function (){
  choose(zofia);
}

document.getElementById("Dokkaebi").onclick = function (){
  choose(dokkaebi);
}
...
document.getElementById("Finka").onclick = function (){
  choose(finka);
}

document.getElementById("Maverick").onclick = function (){
  choose(maverick);
}

document.getElementById("Nomad").onclick = function (){
  choose(nomad);
}

document.getElementById("Gridlock").onclick = function (){
  choose(gridlock);
}

document.getElementById("Nokk").onclick = function (){
  choose(nokk);
}

document.getElementById("Amaru").onclick = function (){
  choose(amaru);
}
...
document.getElementById("Iana").onclick = function (){
  choose(iana);
}
...
document.getElementById("defend").onclick = function () {
  var operator = operators_defenders[Math.floor(Math.random() * operators_attackers.length)];
  document.getElementById("op").innerHTML = operator;
  randomWeapon(operator);
};

document.getElementById("attack").onclick = function () {
  var operator = operators_attackers[Math.floor(Math.random() * operators_attackers.length)];
  document.getElementById("op").innerHTML = operator;
  randomWeapon(operator);
};
...
randomPrimaryAttachments = function (operator, weapon) {
  if(weapon == "OTs-03" || weapon == "CSRX 300" || weapon == "DP 27" || weapon == "Ballistic Shield" || weapon == "G52-Tactical Shield" || weapon == "CCE Shield" || weapon == "Le Roc Shield") {
    var Laser = "None";
    var Grip = "None";
    document.getElementById("primLaser").innerHTML = "Laser: " + Laser;
    document.getElementById("primGrip").innerHTML = "Grip: " + Grip;
    if(weapon == "CCE Shield" || weapon == "Le Roc Shield" || weapon == "CSRX 300") {
      var Scope = "None";
      var Barrel = "None";
    } 
  ...
  document.getElementById("primLaser").innerHTML = "Laser: " + Laser;
  if(weapon == "L85A2") {
    var scopes = Array("None", "Scope 1.5x", "Scope 2.5x", "Holo", "Red Dot", "Reflex");
    var grips = Array("None", "Vertical Grip");
    var barrels = Array("None", "Suppressor", "Compensator", "Muzzle Brake", "Flash Hider");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex");
    var grips = Array("None", "Vertical Grip");
    var barrels = Array("Suppressor", "Compensator", "Muzzle Brake", "Flash Hider", "Extended Barrel");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    var Barrel = barrels[Math.floor(Math.random() * barrels.length)];
  }
    ...
    var scopes = Array("None", "Scope 2.0x", "Scope 2.5x", "Holo", "Red Dot", "Reflex");
    var grips = Array("None", "Angled Grip", "Vertical Grip");
    var barrels = Array("None", "Suppressor", "Compensator", "Muzzle Brake", "Flash Hider");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex","Scope 2.0x", "Scope 2.5x");
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex","Scope 1.5x", "Scope 2.5x");
    var grips = Array("None", "Vertical Grip");
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex", "Scope 1.5x");
    var grips = Array("None");
    var barrels = Array("None", "Suppressor", "Compensator", "Muzzle Brake", "Flash Hider", "Extended Barrel");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    var Barrel = barrels[Math.floor(Math.random() * barrels.length)];
  }
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex", "Scope 1.5x");
    var grips = Array("None","Vertikal Grip","Angled Grip");
    var barrels = Array("None", "Suppressor", "Muzzle Brake", "Flash Hider","Compensator");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    var Barrel = barrels[Math.floor(Math.random() * barrels.length)];
  }
  else if(weapon == "M249") {
    var scopes = Array("None", "Holo", "Red Dot", "Reflex", "Scope 1.5", "Scope 2.0","Scope 3.0x");
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex", "Scope 1.5x","Scope 2.5");
    var grips = Array("None","Vertikal Grip");
    var barrels = Array("None", "Suppressor", "Muzzle Brake", "Flash Hider","Compensator");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex", "Scope 1.5x", "Scope 2.0x", "Scope 2.5x");
    var grips = Array("None","Vertikal Grip");
    var barrels = Array("None", "Suppressor", "Muzzle Brake", "Flash Hider","Compensator");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex", "Scope 1.5x");
    var grips = Array("None", "Vertikal Grip","Angled Grip");
    var barrels = Array("None", "Suppressor", "Muzzle Brake", "Flash Hider","Compensator","Extended Barrel");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    var Barrel = barrels[Math.floor(Math.random() * barrels.length)];
  }
   else if(weapon == "AK-74M") {
    var scopes = Array("None", "Holo", "Red Dot", "Reflex", "Scope 1.5x", "Scope 2.0x");
    var grips = Array("None");
    var barrels = Array("None", "Suppressor", "Muzzle Brake", "Flash Hider","Compensator");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex", "Scope 1.5x", "Scope 2.0x", "Sope 2.5x");
    var grips = Array("None", "Vertikal Grip");
    var barrels = Array("None", "Flash Hider","Compensator");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex", "Scope 1.5x");
    var grips = Array("None");
    var barrels = Array("None", "Suppressor", "Muzzle Brake", "Flash Hider", "Extened Barrel");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    var Barrel = barrels[Math.floor(Math.random() * barrels.length)];
  }
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex");
    var grips = Array("None","Vertikal Grip");
    var barrels = Array("None","Compensator","Muzzle Brake","Flash Hider","Suppressor");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    var Barrel = barrels[Math.floor(Math.random() * barrels.length)];
  }
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex");
    var grips = Array("None");
    var barrels = Array("None","Compensator","Muzzle Brake","Flash Hider","Suppressor","Extended Barrel");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    var Barrel = barrels[Math.floor(Math.random() * barrels.length)];
  }
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex");
    var grips = Array("None","Vertikal Grip", "Angled Grip");
    var barrels = Array("None", "Muzzle Brake", "Flash Hider", "Compensator", "Suppressor");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    var Barrel = barrels[Math.floor(Math.random() * barrels.length)];
  }
    ...
    var scopes = Array("None", "Holo", "Red Dot", "Reflex");
    var grips = Array("None","Vertikal Grip");
    var barrels = Array("None", "Muzzle Brake", "Flash Hider", "Compensator", "Suppressor", "Extended Barrel");
    var Scope = scopes[Math.floor(Math.random() * scopes.length)];
    var Grip = grips[Math.floor(Math.random() * grips.length)];
    var Barrel = barrels[Math.floor(Math.random() * barrels.length)];
  }
